...
--- INGRESO DE DATOS FAMILIAR PROPIETARIO---
...
INSERT INTO FALLECIDO VALUES ('12','Santiago','Lucas','Infarto',TO_DATE('1989/07/01','yyyy/mm/dd'),TO_DATE('2020/07/28 19:02:44', 'yyyy/mm/dd hh24:mi:ss'));
SELECT * FROM  FALLECIDO;


---INSERTAR DATOS EN TRAMITE
...
INSERT INTO TRAMITE VALUES ('17','4','11','2','6',TO_DATE('2020/08/05 ', 'yyyy/mm/dd'),'INHUMACION','ENTIERRO DEL CADAVER','');
INSERT INTO TRAMITE VALUES ('18','4','11','2','6',TO_DATE('2020/08/05 ', 'yyyy/mm/dd'),'INHUMACION','ENTIERRO DEL CADAVER','');
...
INSERT INTO PAGOS VALUES ('17','17','3','3','70,00','EFECTIVO','70'); 
INSERT INTO PAGOS VALUES ('18','17','3','3','70,00','EFECTIVO','70'); 

---IMPEDIR QUE EL VALOR INGRESADO EN PAGOS SEA MATOR QUE EL SALD TOTAL--
...
INSERT INTO Incidente VALUES ('4','4','A','DAÃ‘O A PROPIEDAD PRIVADA','A-4','22:00');
...
INSERT INTO Incidente VALUES ('13','4','A','DAÃ‘O A PROPIEDAD PRIVADA','A-4','22:00');
...
select extract(year from tramite.ANIO_TRAMITE) as año, personal.NOMBRE_PERSONAL, personal.APELLIDO_PERSONAL,tramite.TIPO_TRAMITE, COUNT (TRAMITE.ID_TRAMITE) as CANTIDAS 
from TRAMITE 
INNER join PERSONAL on TRAMITE.ID_PERSONAL = PERSONAL.ID_PERSONAL 
...
INSERT INTO TRAMITE VALUES ('17','6','14','2','6',TO_DATE('2020/08/05 ', 'yyyy/mm/dd'),'INHUMACION','ENTIERRO DEL CADAVER','');
INSERT INTO TRAMITE VALUES ('18','7','15','2','6',TO_DATE('2020/08/05 ', 'yyyy/mm/dd'),'INHUMACION','ENTIERRO DEL CADAVER','');

INSERT INTO TRAMITE VALUES ('16','4','11','2','6',TO_DATE('2020/08/05 ', 'yyyy/mm/dd'),'INHUMACION','ENTIERRO DEL CADAVER','');
INSERT INTO PAGOS VALUES ('17','16','3','3','70,00','EFECTIVO','70,00'); 
INSERT INTO PAGOS VALUES ('18','16','3','3','70,00','EFECTIVO','70,00'); 
INSERT INTO PAGOS VALUES ('16','16','3','3','70,00','EFECTIVO','70,00'); 
INSERT INTO PAGOS VALUES ('13','13','3','3','70,00','TARJETA CREDITO','25'); 
INSERT INTO PAGOS VALUES ('14','14','3','3','90,00','TARJETA CREDITO','90'); 
INSERT INTO PAGOS VALUES ('15','15','3','3','90,00','EFECTIVO','90,00');
INSERT INTO PAGOS VALUES ('16','15','3','3','70,00','EFECTIVO','50,00'); 
SELECT *FROM TRAMITE;
SELECT *FROM pagos;

DELETE FROM PAGOS WHERE ID_PAGO=17
DELETE FROM PAGOS WHERE ID_PAGO=15
DELETE FROM PAGOS WHERE ID_PAGO=16
DELETE FROM tramite WHERE id_tramite=17
DELETE FROM tramite WHERE id_tramite=18
DELETE FROM tramite WHERE id_tramite=16
